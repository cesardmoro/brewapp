app.controller('RecipeLogCtrl', ['$scope','$rootScope' , '$stateParams' , function ($scope, $rootScope, $stateParams, Recipe) {
  ...
  $scope.deleteToggle = function(){
    $scope.activateDelete = !$scope.activateDelete;
  }
