(function() {
    ...
    res.factory('PublishedRecipe',function($resource,$rootScope) {
        ...
        return $resource(baseUrl+'/recipe/:operation:id',{google_id:params,id:'@_id'}, {
    ...
    res.factory('Notification',function($resource,$rootScope) {
        ...
        return $resource(baseUrl+'/notification/:_id',{google_id:params,_id:"@_id"}, {
    ...
    res.factory('Stats',function($resource,$rootScope) {
        ...
        return $resource(baseUrl+'/stats/',{google_id:params}, {
            query: {
                method:'GET',
                params:{},
                isArray:false
    ...
    angular.forEach(services,function(s) {
        res.factory(s,function($resource) {
            return $resource( baseUrl+'/'+ s[0].toLowerCase() + s.substr(1) + '/:_id',{_id:"@_id"}, {});
        });
    });
